...
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		...
		<td><input name="slider[isshow]" type="radio" value="1" <?php if($isshow==1){echo "checked";}?>>&nbsp;<?php echo L('isshow')?>&nbsp;&nbsp;<input
			name="slider[isshow]" type="radio" value="0" <?php if($isshow==0){echo "checked";}?>>&nbsp;<?php echo L('notshow')?></td>
	</tr>

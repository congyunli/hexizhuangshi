...
<table width="100%"  class="table_form">
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="setting[admin_phone]" id="admin_phone" size="30" value="<?php echo $admin_phone?>"/></td>
  </tr>
  <tr>
    <th width="120">联系邮箱</th>
    <td class="y-bg"><input type="text" class="input-text" name="setting[admin_contactEmail]" id="admin_contactEmail" size="30" value="<?php echo $admin_contactEmail?>"/></td>
  </tr>
  <tr>
    <th width="120">公司名称</th>
    <td class="y-bg"><input type="text" class="input-text" name="setting[admin_companyName]" id="admin_companyName" size="30" value="<?php echo $admin_companyName?>"/></td>
  </tr>
  <tr>
    <th width="120">联系地址</th>
    <td class="y-bg"><input type="text" class="input-text" name="setting[admin_address]" id="admin_address" size="50" value="<?php echo $admin_address?>"/></td>
  </tr>
  <tr>
    <th width="120">经度</th>
    <td class="y-bg"><input type="text" class="input-text" name="setting[admin_jd]" id="admin_jd" size="30" value="<?php echo $admin_jd?>"/></td>
  </tr>
  <tr>
    <th width="120">纬度</th>
    <td class="y-bg"><input type="text" class="input-text" name="setting[admin_wd]" id="admin_wd" size="30" value="<?php echo $admin_wd?>"/></td>
  </tr>
  <tr>
    <th width="120" style="color:red">注意</th>
    <td class="y-bg" style="color:red">################ 以下配置请不要自行修改！ ###############<br /></td>
  </tr>
  <tr>

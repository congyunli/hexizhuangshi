...
<div class="header">
    ...
    <div class="rt-col">
    	...
    	<img src="<?php echo IMG_PATH.'icon/lockscreen.png'?>"> <?php echo L('lockscreen')?></a>
    	<span>|</span>
  <!--   	<a href="http://www.phpcms.cn" target="_blank">PHPCMS</a><span>|
    	</span><a href="http://www.phpcms.cn/license/license.php" target="_blank"><?php echo L('authorization')?></a>
    	<span>|</span><a href="http://bbs.phpcms.cn" target="_blank"><?php echo L('igenus_for_postfix')?></a>
    	<span>|</span> -->

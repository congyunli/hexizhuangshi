<?php return array (
  ...
  array (
    ...
    'templates|allsure|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|allsure|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|allsure|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|allsure|pay' => 
    array (
      'deposit.html' => '支付页模板',
    ...
    'templates|allsure|phpsso' => 
    array (
      'index.html' => 'INDEX',
    ),
    'templates|allsure|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|allsure|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|allsure|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|allsure|yp' => 
    array (
      'com_allsure' => '企业默认模板',
      'index.html' => '黄页首页模板',
      'list.html' => '列表页模板',
    ...
    'templates|allsure|yp|com_allsure' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),

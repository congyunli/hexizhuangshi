    ...
    <div class="banner colums case clearfix">
        <div class="left">
            <div class="inner-ctner">
                <?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"slider\" data=\"op=slider&tag_md5=e534ecd6c429a49845fb23417390e4fc&action=lists&postion=58&siteid=%24siteid&order=desc&num=9\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$slider_tag = pc_base::load_app_class("slider_tag", "slider");if (method_exists($slider_tag, 'lists')) {$data = $slider_tag->lists(array('postion'=>'58','siteid'=>$siteid,'order'=>'desc','limit'=>'9',));}?>

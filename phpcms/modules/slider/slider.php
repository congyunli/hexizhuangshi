...
class slider extends admin {
	...
	public function init() {
		...
		$big_menu = array('javascript:window.top.art.dialog({id:\'add\',iframe:\'?m=slider&c=slider&a=add\', title:\''.L('slider_add').'\', width:\'700\', height:\'330\'}, function(){var d = window.top.art.dialog({id:\'add\'}).data.iframe;var form = d.document.getElementById(\'dosubmit\');form.click();return false;}, function(){window.top.art.dialog({id:\'add\'}).close()});void(0);', L('add_slider'));
	...
	//:分类管理
 	public function list_type() {
		...
		$big_menu = array('javascript:window.top.art.dialog({id:\'add\',iframe:\'?m=slider&c=slider&a=add\', title:\''.L('slider_add').'\', width:\'700\', height:\'450\'}, function(){var d = window.top.art.dialog({id:\'add\'}).data.iframe;var form = d.document.getElementById(\'dosubmit\');form.click();return false;}, function(){window.top.art.dialog({id:\'add\'}).close()});void(0);', L('slider_add'));

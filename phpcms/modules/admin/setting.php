...
class setting extends admin {
	...
	public function save() {
		...
		$setting = array();
		$setting['admin_phone'] = trim($_POST['setting']['admin_phone']);
		$setting['admin_contactEmail'] = is_email($_POST['setting']['admin_contactEmail']) ? trim($_POST['setting']['admin_contactEmail']) : showmessage(L('admin_contactEmail'),HTTP_REFERER);
		...
		$setting['admin_companyName'] = trim($_POST['setting']['admin_companyName']);
		$setting['admin_address'] = trim($_POST['setting']['admin_address']);
		$setting['admin_jd'] = trim($_POST['setting']['admin_jd']);
		$setting['admin_wd'] = trim($_POST['setting']['admin_wd']);
